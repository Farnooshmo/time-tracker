...
const Timer = ({ todoId }) => {
  ...
  return (
    <div className='todo-timer'>
      <img src={isTimerRunning ? playStop : playerPlay} alt={isTimerRunning ? 'Stop Timer' : 'Start Timer'} onClick={isTimerRunning ? handleStop : handleStart} style={{ cursor: 'pointer' }} />
      {isTimerRunning ? (
